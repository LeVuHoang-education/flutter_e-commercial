...
import 'package:e_commercial_app/core/services/network/dio_client.dart';
  ...
  Future <void> _handlerefreshToken(DioException err, ErrorInterceptorHandler handler) async {
    ...
    try{
      ...
      , (data) async {
            ...
            final newRequest = await sl<DioClient>().get(oldRequest.path, options: Options(headers: oldRequest.headers));
